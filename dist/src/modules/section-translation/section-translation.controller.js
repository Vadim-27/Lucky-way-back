...
let SectionTranslationController = class SectionTranslationController {
    ...
    async update(sectionId, updateSectionTranslationDto) {
        return this.sectionTranslationService.update(sectionId, updateSectionTranslationDto);
    }
    async remove(id) {
...
__decorate([
    (0, common_1.Patch)(':sectionId/update'),
    (0, swagger_1.ApiOperation)({ summary: 'Update or create a section translation' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, section_translation_dto_1.UpdateSectionTranslationDto]),
    __metadata("design:returntype", Promise)
